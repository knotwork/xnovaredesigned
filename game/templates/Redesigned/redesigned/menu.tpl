...
-->
		...
		<li class="menubutton_table">
			<span class="menu_icon">
		  		<img src="{{skin}}/img/navigation/navi_ikon_research_{let_research}.gif" height="29" width="38" />
			</span>
			<a class="menubutton" href="./?page=techtree" title="Technologies" tabindex="1">
				<span class="textlabel">Technologies</span>
			</a>
		</li>
