...
PlanetResourceUpdate($userclass->uarray,$planetrow);
...
// my little fix:
	define('HEADER_CACHE',GAME_SKIN.'/img/header/');
...
//			}
			...
			if($planetrow['planet_type'] == 3){
				$parse['headerimg'] = $parse['subtype'].'.png';
			}else{
				$parse['headerimg'] = $parse['type'].'.png';
			}
